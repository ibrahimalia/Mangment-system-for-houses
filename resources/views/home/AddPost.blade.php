...
@if(session('post'))
    <div class="alert ">
        <span class="msg">{{session('post')}}</span>
        <div class="close-btn">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="" method="post"  enctype="multipart/form-data">
                                            @csrf
                                            <strong>Image:</strong>
                                            <input type="file" name="postImage[]" class="form-control @error('postImage') is-invalid @enderror" style="height: 40px" multiple required>
                                            @error('postImage')
                                            <div class="mes" style="color: red">{{ $message }}</div>
                                            @enderror
                                            <strong>Description:</strong>
                                            <textarea  name="contentPost" class="form-control  @error('contentPost') is-invalid @enderror"  style="height: 300px;font-size: 20px"></textarea>
                                            @error('contentPost')
                                            <div class="mes" style="color: red">{{ $message }}</div>
                                            @enderror
                                            <br>
