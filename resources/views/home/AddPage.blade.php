...
<div id="app">
    ...
    <div class="container" v-bind:style="className">
        <a href="/card" style="text-decoration-line: none;color: black;font-size: 30px;float:right;top: 0px;right:0;position: absolute" title="Return  Home"><strong><i class="fa fa-fast-backward" style="font-size:40px;color:red"></i></strong></a>
