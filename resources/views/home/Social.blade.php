...
<head>
    ...
    <style>
        ...
        #load{
            ...
            cursor: pointer; position:center;width:300px;float: right;
        }
        .Disabled{
            pointer-events: none;
            cursor: not-allowed;
                                    ...
                                    <div class="w3-white">
                                       <a href="/AddPost"> <button  class="w3-button w3-block  w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i> ADD POST</button></a>
                                        <div class="w3-dropdown-hover ">
                                            <button class="w3-button w3-block  w3-left-align" title="Notifications"><i class="fa fa-bell"></i><span class="w3-badge w3-right w3-small w3-green">3</span> <span>Notification</span></button>
          ...
          <i class="fa fa-remove"></i>
                            ...
                            <div class="w3-col m7">
                                ...
                                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                                    ...
                                    <span class="w3-right w3-opacity" style="font-size: 10px">{{$property->time}}</span>
                                    <h4>{{$property->name}}</h4><br>
                                    <hr class="w3-clear">
                                    <p> {{$property->contentPost}}<br></p>
